        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-background/80">
              Experience the authentic beauty of Tanzania with our expertly
              crafted safari tours and cultural adventures.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <Link
                to="/destinations/ngorongoro"
                className="block hover:text-primary transition-colors"
              >
                Ngorongoro Crater
              </Link>
              <Link
                to="/destinations/tarangire"
                className="block hover:text-primary transition-colors"
              >
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-background/80">
                    Plot 123, Safari Road, Arusha, Tanzania
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-background/80">
                    Plot 456, Ocean Drive, Dar es Salaam
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4" />
                <span>+255 762 418 176</span>
              </div>
              <div className="flex items-center space-x-2">
