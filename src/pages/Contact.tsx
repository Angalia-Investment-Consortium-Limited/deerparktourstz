  ...
  const userTypes = [
    {
      ...
      icon: DollarSign,
      description: "Students, solo travelers, backpackers",
    },
    {
      id: "family" as const,
      label: "Families & Couples",
      icon: Heart,
      description: "Mid-range comfort seekers",
    },
    {
      id: "luxury" as const,
      label: "Luxury Travelers",
      icon: Crown,
      description: "VIP experiences, honeymooners",
    },
    {
      id: "agents" as const,
      label: "Travel Agents",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Get in touch with our safari experts for personalized
              recommendations, custom itineraries, and exclusive deals tailored
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                We're here to help with any questions about your Tanzania safari
                adventure
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {contactInfo.map((info, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="text-center hover:shadow-card-custom transition-shadow"
                  >
                    <CardHeader>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-8 opacity-90">
              Our safari specialists are standing by to help you plan the
              perfect Tanzania adventure. Get instant answers to your questions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary">
                <Phone className="mr-2 h-4 w-4" />
                Call Now: +255 762 418 176
              </Button>
